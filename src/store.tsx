...
class Store {
  ...
  contacts: Contact[] = [
    {
      name: 'Jason Ehle',
      id: 'jason.ehle@gmail.com',
      position: 'Manager',
      photo: 'https://uifaces.co/our-content/donated/d5f5cc2a8835d69d6dde70875a793ce6.jpeg',
      bio,
    },
    {
      name: 'Yifei Liu',
      id: 'yifei.liu@gmail.com',
      position: 'Director',
      photo:
    ...
    {
      name: 'Manuel Osorio',
      id: 'manuel.osorio(mkd)@gmail.com',
  ...
  selectedContactEmail = this.contacts[0].id
}
